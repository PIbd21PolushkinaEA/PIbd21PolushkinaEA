 ...
 where T : class, ITransport
    {
        ...
        public void Draw(Graphics g)
        {
            ...
            {
                truck.Value.DrawTruckTrailer(g);
            }
        }
        /// <summary>
            ...
            else if (_places.Count > 0)
            {
                ...
                for (int i = 0; i < _places.Count; ++i)
                {
                   ...
                   TruckTrailer)
                    ...
                    if (_places[thisKeys[i]] is TruckTrailer && other._places[thisKeys[i]] is
                    Truck)
                    {
                        return -1;
                    }
                    ...
                    {
                        return (_places[thisKeys[i]] is
                       TruckTrailer).CompareTo(other._places[thisKeys[i]] is TruckTrailer);
                    }
                }
            }
            return 0;
